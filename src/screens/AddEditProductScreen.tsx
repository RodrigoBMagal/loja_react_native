...
import {
  ...
  TextInputProps, KeyboardTypeOptions,
} from 'react-native';
import { StackScreenProps } from '@react-navigation/stack';
import { useStock, CATEGORIES, CATEGORY_COLORS } from '../context/StockContext';
import { RootStackParamList } from '../types';

type Props = StackScreenProps<RootStackParamList, 'AddEditProduct'>;
...
const Input = ({ value, onChangeText, placeholder, keyboardType = 'default', ...props }: InputProps) => (
  <TextInput
    style={styles.input}
    value={value}
...
const AddEditProductScreen = ({ navigation, route }: Props) => {
  ...
  const parseISOToDisplay = (isoStr: string | null): string => {
    if (!isoStr) return '';
